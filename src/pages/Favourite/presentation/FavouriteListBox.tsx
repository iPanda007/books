            ...
            <div>
              <div className="flex gap-2 mb-3">
                ...
                <div>
                  ...
                  <div className="text-xs">{item.authors}</div>
                </div>
              </div>
            </div>
          ))}
        </div>
        <div className="flex mt-[-20px] justify-center bottom-0 left-0 w-full bg-gradient-to-b from-transparent to-[#fff] py-4 backdrop-blur-[0.4px]"></div>
